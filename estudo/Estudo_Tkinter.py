...
def tela1():
    ...
    #-----------------------------------------------------------------------------------------------------------------------------#
    labelFrame2 = LabelFrame(labelFrame1, width = 0.4 * panned2Width, height = 0.05 * panned2Height, font = ("Arial", 12))
    labelFrame2.place(x = 0.01 * panned2Width, y = 0.05 * panned2Height)
    labelFrame2Width = 0.1 * labelFrame2.winfo_width()
    labelFrame2Height = 0.1 * labelFrame2.winfo_height()
    #---#
    selected = StringVar()
    #selected.set("Docente")
    rd1 = ttk.Radiobutton(labelFrame2Width, text = "Docente", value = "Docente", variable = selected)
    rd2 = Radiobutton(labelFrame2Width, text = "Estudante")
    rd3 = Radiobutton(labelFrame2Width, text = "Externo")
    rd1.place(x = 0.1 * labelFrame2Width, y = 0.1 * labelFrame2Height)
